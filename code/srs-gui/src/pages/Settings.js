...
function SystemsImpl() {
    ...
    React.useEffect(() => {
        ...
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/window/query'), {
            ...token,
        }).then(res => {
...
function SettingNginx() {
    ...
    const updateHlsDelivery = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/nginx/hls'), {
    ...
    const updateReverseProxy = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/nginx/proxy'), {
...
function SettingTools({ defaultWindow }) {
    ...
    const enablePlatformAccess = React.useCallback((e, enabled) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/pubkey'), {
            ...token, enabled,
        }).then(res => {
    ...
    const updateLbBackends = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/dns/backend/update'), {
...
function SettingPlatform({ defaultWindow }) {
    ...
    const setupUpgradeWindow = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/window/update'), {
...
function SettingOpenApi({ copyToClipboard }) {
    ...
    React.useEffect(() => {
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/secret/query'), {
            ...token,
        }).then(res => {
    ...
    const createApiToken = React.useCallback((e) => {
        ...
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/secret/token'), {
            apiSecret
        }).then(res => {
...
function SettingBeian() {
    ...
    const updateBeian = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/beian/update'), {
    ...
    const updateHomepage = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/nginx/homepage'), {
            ...token, homepage,
        }).then(res => {
            alert(t('helper.setOk'));
        }).catch(handleError);
...
function SettingAuth() {
    ...
    const updateSecret = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/hooks/srs/secret/update'), {
            ...token, secret,
        }).then(res => {
    ...
    const updateNoAuth = React.useCallback((e) => {
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/hooks/srs/secret/disable'), {
...
function SettingHttps() {
    ...
    const updateSSL = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/ssl'), {
            ...token, key, crt,
        }).then(res => {
    ...
    const requestLetsEncrypt = React.useCallback((e) => {
        ...
        const token = Token.load();
        axios.post(addURLPrefix(MGMT_HOST, MGMT_PORT, '/terraform/v1/mgmt/letsencrypt'), {
            ...token, domain,
        }).then(res => {
